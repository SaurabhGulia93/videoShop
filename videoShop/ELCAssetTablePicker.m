...
- (void)preparePhotos
{
    ...
    dispatch_sync(dispatch_get_main_queue(), ^{
        [self.tableView reloadData];
        // scroll to bottom
        NSLog(@"[self numberOfSectionsInTableView:self.tableView] = %d",[self numberOfSectionsInTableView:self.tableView]);
        int section = [self numberOfSectionsInTableView:self.tableView] - 1;
        NSLog(@"[self tableView:self.tableView numberOfRowsInSection:section] = %d",[self tableView:self.tableView numberOfRowsInSection:section]);
